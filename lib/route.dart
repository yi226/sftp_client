...
import 'package:sftp_client/screens/home.dart';
  ...
  routes: [
    ShellRoute(
      ...
      routes: [
        ...
        /// Settings
        GoRoute(
            path: '/settings', builder: (context, state) => const HomePage()),
      ],
    ),
  ],
);
...
class _MainPageState extends State<MainPage> with WindowListener {
  ...
  late final List<NavigationPaneItem> originalItems = [
    ...
    PaneItemHeader(header: const Text('File')),
    PaneItem(
  ...
  late final List<NavigationPaneItem> footerItems = [
    ...
    _LinkPaneItemAction(
      ...
      link: 'https://github.com/yi226/sftp_client',
      body: const SizedBox.shrink(),
    ),
  ];
    ...
    return NavigationView(
      ...
      pane: NavigationPane(
        ...
        header: SizedBox(
          ...
          child: ShaderMask(
            shaderCallback: (rect) {
              final color = config.color.defaultBrushFor(
                theme.brightness,
              );
